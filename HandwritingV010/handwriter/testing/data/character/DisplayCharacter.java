...
public class DisplayCharacter {
    ...
    public static void createAndShowGUI() throws IOException {
		...
		chars = ReadTrainingCharacters.getCharsFromFile("testingcharacters/1/1_24.ts");

		//chars = ReadTrainingCharacters.getCharsFromFile("trainingcharacters/choose_from_all/5_24.tr");

		...
		saveChar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {  // add training character
					...
					//fstream = new FileWriter("testingcharacters/0/cap_6_" + file.getText() + ".ts", true);
					
					fstream = new FileWriter("trainingcharacters/choose_from_all/cap_11_" + file.getText() + ".tr", true);

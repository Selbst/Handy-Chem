...
public class Testing_Molecules_Create {
    public static void createAndShowGUI() {
		JFrame frame = new JFrame("title"); frame.setSize(1000, 1000);
		JPanel panel = new JPanel();
		JButton saveChar = new JButton("Save Molecule"); panel.add(saveChar);
		...
		final Mol_Panel drawpanel = new Mol_Panel();
		...
		saveChar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {  // add training character
					...
					//fstream = new FileWriter("testingcharacters/0/7_" + file.getText() + ".ts", true);
					
					fstream = new FileWriter("testing/molecule_samples/raw_samples/" + file.getText() + ".mol", true);
...
class Mol_Panel extends JPanel {

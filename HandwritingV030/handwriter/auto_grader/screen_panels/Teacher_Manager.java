...
public class Teacher_Manager extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        class_list.addListSelectionListener(new Class_Selection_Listener());
        assignment_list.addListSelectionListener(new Assignment_Selection_Listener());
    }// </editor-fold>
    ...
    private void open_assignment_buttonActionPerformed(java.awt.event.ActionEvent evt) {
    	...
    	parent.set_questions();
        ((CardLayout)parent.getContentPane().getLayout()).show(parent.getContentPane(), "questions_manager");
    }
    public void set_class_list(String[] list) {
    	class_list.setListData(list);
    }
    public void set_student_list(String selected_class) {
    	student_list.setListData(parent.students[parent.find_class_index(selected_class)]);
    	for (String s : parent.students[parent.find_class_index(selected_class)]) {
    		System.out.println(s);
    	}
    }
    public void set_assignment_list(String selected_class) {
    	assignment_list.setListData(parent.assignments[parent.find_class_index(selected_class)]);
    	for (String s : parent.assignments[parent.find_class_index(selected_class)]) {
    		System.out.println(s);
    	}
    }
    
    class Class_Selection_Listener implements ListSelectionListener {
        ...
        public void valueChanged(ListSelectionEvent evt) {
            ...
            if (!evt.getValueIsAdjusting()) {
                ...
                if (selected.length == 1) {
                	parent.current_class = (String)selected[0]; 
                	set_student_list((String)selected[0]);
                	set_assignment_list((String)selected[0]);
                	class_indicator_assignments.setText((String)selected[0]);
                	class_indicator_students.setText((String)selected[0]);
    ...
    class Assignment_Selection_Listener implements ListSelectionListener {
        // This method is called each time the user changes the set of selected items
        public void valueChanged(ListSelectionEvent evt) {
            // When the user release the mouse button and completes the selection,
            // getValueIsAdjusting() becomes false
            if (!evt.getValueIsAdjusting()) {
                ...
                Object[] selected = list.getSelectedValues();
                if (selected.length == 1) {
                	parent.current_assignment = (String)selected[0]; 
                	//parent.set_questions();
                }
            }
        }
